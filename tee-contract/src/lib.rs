...
impl exports::z::tenant_flight::contracts::Guest for Component {
    ...
    fn attest_source(req: exports::z::tenant_flight::contracts::GenericInput) -> Result<Vec<u8>, String> {
        let input = req.input.ok_or("attest-source: missing input")?;
        attest::attest_source(&input)
    }
}
